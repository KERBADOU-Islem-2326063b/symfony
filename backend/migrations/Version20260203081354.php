 ...
 */
final class Version20260203081354 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE question ADD CONSTRAINT FK_B6F7494EB011A311 FOREIGN KEY (expected_response_id) REFERENCES response (id)');
